...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .chart-header { display: flex; align-items: flex-start; justify-content: space-between; margin-bottom: 0.5rem; position: relative; }
        ...
        .chart-icon {
            width: 40px; height: 40px; margin-right: 1rem; border-radius: 10px; display: flex;
            align-items: center; justify-content: center; font-size: 1.1rem; color: #3b82f6;
        ...
        .tag {
            ...
            margin-right: 0.3rem; margin-bottom: 0.25rem; border: 1px solid rgba(59, 130, 246, 0.25);
        }
        .footer-content {
