    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .install-command {
            ...
            margin-top: auto; position: relative; display: flex; align-items: center; justify-content: center;
        }
        .copy-btn {
            position: absolute; right: 0.75rem; background: rgba(59, 130, 246, 0.2); border: 1px solid #3b82f6;
            color: #3b82f6; padding: 0.3rem; border-radius: 4px; cursor: pointer; font-size: 0.7rem;
    ...
    html_content += f'''
                <div class="chart-card">
                    ...
                    <div class="install-command">
                        <span>helm install {install_name} jeanlopezxyz/{chart['name']}</span>
